...
$category = mysql_query("SELECT *FROM `tbl_customers`");
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
            ...
            <div class="content-section">
                <div class="container-liquid">
                    <div class="row">
                        <a href="test_import_customers.php" class="btn btn-primary style2 pull-right">IMPORT CUSTOMERS</a>
                        <div class="col-xs-12">
                                    ...
                                    <div class="table-box">
                                        ...
                                        <table class="display table" id="example">
                                            ...
                                            while($rows = mysql_fetch_array($category))
                                            {
                                                ...
                                                <td class=" "><?php echo $rows['category'];?>  </td>
                                                ...
                                                <!-- <td class="">
                                          <?php echo  '<a  href="edit_customer.php?id='.$category_id.'">Edit</a>'; ?></td> -->
                                                 <!--  <a href="edit_category.php?id='.$user_id.'">Edit</a> -->
