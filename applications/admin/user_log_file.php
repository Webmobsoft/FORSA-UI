...
<div class="wrapper">
    ...
    vertical-align: top;
            ...
            <?php
$select_lender = mysql_query("SELECT tbl_users . * , tbl_lender_services.name as category_name, tbl_fedafin_rating.rating_name as fedafin_rating FROM `tbl_users` LEFT JOIN tbl_lender_services ON tbl_lender_services.id = tbl_users.category
 LEFT JOIN tbl_fedafin_rating ON tbl_fedafin_rating.id = tbl_users.fedafin_rating") ;// WHERE user_type = 'borrower'
...
//                                                echo '</pre>';
                                                ...
                                                ?>
                                                <tr class="gradeX">
                                                    <td class=" "><?php //echo $rows['uname'];?> 
                                                        <a href="user_log_file_detail.php?id=<?php echo $rows['id']; ?>"  id="user_detail"> <?php echo $rows['uname'];?></a>
                                                ...
                                                <td class=" "><?php echo $rows['company_name'];?> 
                                                </td>
                                                <td class=" "><?php echo $rows['contact_number'];?></td>
                                                <td class=" " style="padding:none;"><?php echo $rows['email'];?></td>
                                                <td class="a-right a-right "><?php echo $rows['fedafin_rating'];?></td>
                                                ...
                                                <td class=" last">
                                                   ...
                                                   if($rows['status'] == 'y')
                                                   {
                                                       echo "<td class='hideMyDiv'><span id='status_bulb_".$user_id."'><img src='assets/images/bulb_on.png' title='Disable' onclick='make_it_off(".$user_id.")'></span>"
...
echo '<a class="deleteUserById" data-id="'.base64_encode($user_id).'" href="javascript:void(0);"><i class="fa fa-times fa-2x red"></i></a></td>';
                                                   ...
                                                   {
                                                       echo "<td class='hideMyDiv'><span id='status_bulb_".$user_id."'><img src='assets/images/bulb_off.png' title='Enable' onclick='make_it_on(".$user_id.")'></span>"
                                                               . "<a href='edit_user.php?id=".$user_id."'>Edit</a>";
echo '<a class="deleteUserById" data-id="'.base64_encode($user_id).'" href="javascript:void(0);"><i class="fa fa-times fa-2x red"></i></a></td>';
                                                        echo "<td  class='loan_td'><a href='open_loan.php?id=".$user_id."'>Open</a></br><a href='closed_loan.php?id=".$user_id."'>Close</a></td>";
                                                   }
