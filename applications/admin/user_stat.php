		...
		include_once 'config.php';
                ...
                $user_status= mysql_query("SELECT tbl_users.fname, tbl_users.lname,tbl_users.company_name,  tbl_user_status.is_logged, tbl_user_status.last_login , tbl_user_status.user_id
							FROM tbl_users LEFT JOIN tbl_user_status ON tbl_users.id = tbl_user_status.user_id 
                                                        WHERE tbl_users.is_archieve = 'n' AND tbl_users.user_type != 'admin' "); 
			...
			?>
						...
						<?php
							while($rows = mysql_fetch_array($user_status))
							{
                                                        ?>
                                                       <tr class="gradeX">
                                                           <td><a href="user_log_details.php?id=<?php echo $rows['user_id']; ?>"  id="user_detail"> <?php echo $rows['fname'] ." " .$rows['lname'];?></a></td>                                                   <td><?php echo $rows['company_name'];?></td>
