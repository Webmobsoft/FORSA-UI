	...
	<div class="structure-row">
        ...
        <div class="right-sec">
            ...
            <!-- Content Section Start -->
			 ...
			 $userid = $_GET['id'];
				$user_status= mysqli_query($mysql_connect,"SELECT tbl_customers.first_name, tbl_customers.Surname,tbl_customers.Name_company, tbl_view_user_logged_status.is_logged, tbl_view_user_logged_status.last_login, tbl_view_user_logged_status.last_logout , tbl_view_user_logged_status.user_id, tbl_view_user_logged_status.ip_address FROM tbl_customers INNER JOIN tbl_view_user_logged_status ON tbl_customers.id=tbl_view_user_logged_status.user_id WHERE tbl_view_user_logged_status.user_id = '$userid' ORDER BY tbl_view_user_logged_status.id DESC"); 
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">View User Status</h2><script type="text/javascript" src="assets/js/jquery.dataTables.min.js"></script>
                                        ...
                                        <table class="display table" id="example">
											...
											<?php
											  while($rows = mysqli_fetch_array($user_status))
											  {
												 ...
												 ?>
												 <tr class="gradeX">
                                                   <td><a href="#"  id="user_detail"> <?php echo $rows['first_name'] ." " .$rows['Surname'];?></a></td>                                                   <td><?php echo $rows['Name_company'];?></td>
