...
<div class="wrapper">
    <div class="structure-row">
        ...
        <div class="right-sec">
            ...
            // exit();
            $select_lender = mysqli_query($mysql_connect,"SELECT tbl_emails.*, concat((tbl_customers.first_name), (' '), (tbl_customers.Surname)) as name FROM `tbl_emails` inner join tbl_customers on tbl_customers.id = tbl_emails.to");
