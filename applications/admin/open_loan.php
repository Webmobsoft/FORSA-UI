...
<div class="wrapper">
    <div class="structure-row">
        ...
        <div class="right-sec">
            ...
            if (isset($_GET['id'])) {
                $user_id = $_GET['id'];
                $select_closed_loan = mysql_query("select tbl_borrower_request.*,tbl_users.fname,tbl_users.lname from tbl_borrower_request inner join tbl_users on tbl_users.id = tbl_borrower_request.borrower_id where tbl_borrower_request.status='open' and tbl_borrower_request.borrower_id='$user_id'");
            } else {
                $select_closed_loan = mysql_query("select tbl_borrower_request.*,tbl_users.fname,tbl_users.lname from tbl_borrower_request inner join tbl_users on tbl_users.id = tbl_borrower_request.borrower_id where tbl_borrower_request.status='open'");
            }
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Live Requests</h2>
                                </header>
                                <div class="contents">
       ...
       // die;
        ...
        ?>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td><?php echo $rows['currency']; ?></td></td>
