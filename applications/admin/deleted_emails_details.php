...
<div class="wrapper">
    <div class="structure-row">
        ...
        <div class="right-sec">
            ...
            <?php
            if($by == "P"){
                $table = "tbl_password_email";
            }elseif($by == "O"){
                $table = "tbl_onboard_emails";
            }elseif($by == "C")
            {
                $table = "tbl_confirmation_email";
            }else{
                $table = "tbl_emails";
            }
            $select_query = mysqli_query($mysql_connect,"SELECT message FROM  ".$table." WHERE id = ".$id." ");
                ...
                <div class="container-liquid">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="sec-box">
                              <span id="add"><a href="deleted_mails.php" class="btn btn-primary style2" style="float: right;">Back to list</a></span>
                                <a class="closethis">Close</a>
                                <header>
                                    <h2 class="heading">Deleted Email Details</h2>
