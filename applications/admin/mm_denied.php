...
<div class="wrapper">
    <div class="structure-row">
        ...
        <div class="right-sec">
            ...
            <?php
            $select_closed_loan = mysql_query("SELECT * FROM `tbl_market_lender_response` where request_status='d'");
            $selected_accepted_offers = mysql_query("SELECT `tbl_market_offers_responces`.*,`tbl_users`.`fname` as borowerFname ,`tbl_users`.`lname` as borowerLname, `tbl_users`.`company_name` FROM `tbl_market_offers_responces` INNER JOIN `tbl_users` ON `tbl_users`.`id` = `tbl_market_offers_responces`.`borrower_id` WHERE `tbl_market_offers_responces`.`is_accepted` = 'd' AND tbl_users.is_archieve = 'n' ");
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">MM DENIED TRADES</h2>
                                </header>
                                <div class="contents">
        ...
        ?>
                                                        ...
                                                        ?>
                                                            ...
                                                            while ($rowS = mysql_fetch_array($selected_accepted_offers)) {
                                                                ...
                                                                $mat_date = $rowS['maturity_date'];
                                                                $dealId = $rowS['id'];
                                                                $currency = $fetchTerm['currency_type'];
                                                                $val_date = $rowS['value_date'];
                                                                ?>
...
<tfoot>
                                                    <!--<tr>
                                                        ...
                                                        <th><input type="text" name="search_grade" value="Search grades" class="search_init" /></th>
                                                            ...
                                                            echo "<i style=color:red>MM DENIED TRADES LIST EMPTY</i>";
                                                        }
                                                        ?>
                                              <script>
