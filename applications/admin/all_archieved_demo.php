    ...
    <div class="structure-row">
        ...
        <div class="right-sec">
			...
			<?php 
			  ...
			  {
				 $archieveAllDemoRequests = mysql_query("UPDATE `tbl_demo` SET `is_archieve` ='n' ");
				 $updatedStatus = "1" ;
			  }
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="sec-box">
                                ...
                                <header style="height:60px;">
                                    ...
                                    <div id="alertArea" class="alert alert-success col-md-12" style="">All demo requests active successfully</div>
                                    <?php } ?>
                                    <h2 class="heading" style="float:left">All Archieved Demo Requests</h2>
									<span style="float:right;margin-right:15%;">
									  <form action="" method="POST">
									    <input class="btn btn-primary style2" placeholder="" name="archieveAll" value="Active All"  type="submit">
									  </form>
									</span>
                                </header>
                                <div class="contents">
                                    ...
                                    <div class="table-box">
                                        <script type="text/javascript" src="assets/js/jquery.dataTables.min.js"></script>
                                            ...
                                            <table class="display table col-xs-12 col-md-12" id="example">
                                                <thead>
                                                    <tr>
                                                        <th>First Name </th>
                                                        <th>Name Title </th>
...
<?php    
  ...
  $demo_request = mysql_query("SELECT * FROM `tbl_demo` WHERE `is_archieve` = 'y' ORDER BY `id` DESC");
...
?>
                                                    ...
                                                    <tr class="gradeX" id="demoRequestId<?php echo $requestId; ?>">
                                                            ...
                                                            <td> <input type="radio" class="f-option" name="selector" style="font-size:50px;cursor:pointer" title="Active this" onclick="activeThisDemo(<?php echo $requestId; ?>)"></td>
                                                            <td><input type="radio" class="f-option" name="delete" style="font-size:50px;cursor:pointer" title="Delete this" onclick="deleteThisDemo(<?php echo $requestId; ?>)"></td>
                                                        <?php
                                                            }
                                                        ?>
                                                 </tr>
...
<script>
 ...
 function activeThisDemo(demoId)
 {
	
	var conf = confirm("Are you sure to active this ?");
	
	if(conf == true)
	{
		var data_to_send = "demoId="+demoId+"&function=activeThisDemo";
		//alert(data_to_send);
		$.ajax({
 ...
 function deleteThisDemo(demoId)
 {
     var conf = confirm("Are you sure to delete this ?");
	
	if(conf == true)
	{
		var data_to_send = "demoId="+demoId+"&function=deleteThisDemo";
		//alert(data_to_send);
		$.ajax({
