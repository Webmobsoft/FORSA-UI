...
<div class="wrapper">
    ...
    vertical-align: top;
            ...
            <?php
$select_lender = mysqli_query($mysql_connect,"SELECT * FROM `tbl_users` WHERE  tbl_users.status = 'n'");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title user_popup_heading" id="myModalLabel">Live Deleted Users</h4>
      </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Live Deleted Users</h2>
                                </header>
                                <div class="contents">
