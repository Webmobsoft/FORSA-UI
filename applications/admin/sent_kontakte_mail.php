...
<div class="wrapper">
    <div class="structure-row">
        ...
        <div class="right-sec">
            ...
            // exit();
            $select_lender = mysqli_query($mysql_connect,"SELECT tbl_emails.*, tbl_customers.first_name, tbl_customers.Surname  FROM `tbl_emails` inner join tbl_customers on tbl_customers.id = tbl_emails.to where tbl_emails.status = 'Y'");
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Sent Kontakte Email </h2>
                                </header>
                                <div class="contents">
...
//                                                echo '</pre>';
                                                        ...
                                                        <tr class="gradeX">
                                                          ...
                                                          <td><a href="kontakte_email_details.php?id=<?php echo $rows['id'];?>"><?php echo $rows['subject']." - ".$small = substr($rows['message'], 0, 35)."....";  ?></a></td>
                                                            <td><?php echo date('d/m/Y H:ia', strtotime($rows['sent_at'])); ?></td>
                                                           <td><a class="deletekontakteEmail" data-id=<?php echo $user_id;?> href="javascript:void(0);"><i class="fa fa-times fa-2x red"></i></a></td>
...
<script>
 ...
 $('.deletekontakteEmail').click(function(){
 
 var id = $(this).data('id');
 var obj = $(this);
 var check = confirm('Do you really want to delete this email.');
 if(check == true) {
   var data_to_send = 'id=' + id +'&table=tbl_emails&function=deleteEmails';
   $.ajax({
